...
def run_text_only(model: str, max_completion_tokens: int) -> None:
    ...
    print(f"run_text_only chat_completion: {chat_completion}\n")
    # ChatCompletion(
    #     id='chatcmpl-8b4e0e0901818c78',
    #     choices=[
    #         Choice(
    #             finish_reason='stop',
    #             index=0,
    ...
    #                 content=' The capital of France is Paris.mF}$.a',
    #                 refusal=None,
    #                 role='assistant',
    #                 annotations=None,
    #                 audio=None,
...
def run_single_image(model: str, max_completion_tokens: int) -> None:
    ...
    image_file = (
        "./media/2560px-Gfp-wisconsin-madison-the-nature-boardwalk.jpg"  # local file
    )
    ...
    if os.path.exists(image_file):
        ...
        print(
            f"run_single_image chat_completion_from_local_image_base64: {chat_completion_from_local_image_base64}"
        )
        # ChatCompletion(
        #     id="chatcmpl-a2ae4ae97327d87b",
        #     choices=[
        #         Choice(
        #             finish_reason="stop",
        #             index=0,
        #             logprobs=None,
        #             message=ChatCompletionMessage(
        #                 content=" The image features a narrow path leading into a vast grass field. As the path winds through the field, it appears to be made of wood for durability. The scene beyond presents a seemingly endless expanse of tall, green grass, giving depth and openness to the landscape. The path is surrounded by the wide-open space, and if one were to look towards the left, they would notice a forest in the background. Overall, the scene showcases a beautiful, open landscape accessible via the wooden path.",
        #                 refusal=None,
        #                 role="assistant",
        #                 annotations=None,
        #                 audio=None,
...
def run_multi_image(model: str, max_completion_tokens: int) -> None:
    ...
    image_path_duck = "./media/duck.jpg"
    image_path_lion = "./media/lion.jpg"
    image_path_duck_base64 = encode_base64_content_from_file(image_path_duck)
    image_path_lion_base64 = encode_base64_content_from_file(image_path_lion)
    chat_completion_from_url = client.chat.completions.create(
        messages=[
            {
                "role": "user",
                "content": [
                    {"type": "text", "text": "What are the animals in these images?"},
                    {
                        "type": "image_url",
                        "image_url": {
                            "url": f"data:image/jpeg;base64,{image_path_duck_base64}"
                        },
                    },
                    {
                        "type": "image_url",
                        "image_url": {
                            "url": f"data:image/jpeg;base64,{image_path_lion_base64}"
                        },
                    },
                ],
            }
    ...
    print(f"run_multi_image chat_completion_from_url: {chat_completion_from_url}")
    # ChatCompletion(
    #     id="chatcmpl-ae7869f77bcba320",
    #     choices=[
    #         Choice(
    #             finish_reason="stop",
    #             index=0,
...
python 16_openai_chat_completion_client_for_multimodal.py --chat-type=text-only
python 16_openai_chat_completion_client_for_multimodal.py --chat-type=single-image
...
vllm serve \
/model/Phi-3.5-vision-instruct \
--served-model-name Phi-3.5-vision-instruct \
--trust-remote-code \
--use-tqdm-on-load \
--host 0.0.0.0 \
--port 8000 \
...
python 16_openai_chat_completion_client_for_multimodal.py --chat-type=multi-image
