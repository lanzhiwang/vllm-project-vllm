...
* https://docs.vllm.ai/en/v0.20.0/examples/online_serving/batched_chat_completions/

Source [https://github.com/vllm-project/vllm/blob/main/examples/online_serving/batched_chat_completions.py](https://github.com/vllm-project/vllm/blob/main/examples/online_serving/batched_chat_completions.py).
